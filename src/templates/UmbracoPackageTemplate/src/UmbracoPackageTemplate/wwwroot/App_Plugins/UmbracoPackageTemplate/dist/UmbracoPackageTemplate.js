 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const O = globalThis, I = O.ShadowRoot && (O.ShadyCSS === void 0 || O.ShadyCSS.nativeShadow) && "adoptedStyleSheets" in Document.prototype && "replace" in CSSStyleSheet.prototype, B = Symbol(), W = /* @__PURE__ */ new WeakMap();
let tt = class {
  constructor(t, e, s) {
...
const lt = (r) => new tt(typeof r == "string" ? r : r + "", void 0, B), at = (r, ...t) => {
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const { is: dt, defineProperty: pt, getOwnPropertyDescriptor: ut, getOwnPropertyNames: $t, getOwnPropertySymbols: _t, getPrototypeOf: ft } = Object, f = globalThis, q = f.trustedTypes, At = q ? q.emptyScript : "", M = f.reactiveElementPolyfillSupport, b = (r, t) => r, z = { toAttribute(r, t) {
  switch (t) {
    case Boolean:
      r = r ? At : null;
      break;
  ...
  return e;
} }, et = (r, t) => !dt(r, t), J = { attribute: !0, type: String, converter: z, reflect: !1, hasChanged: et };
...
class y extends HTMLElement {
  ...
  _$AK(t, e) {
    ...
    if (i !== void 0 && this._$Em !== i) {
      const n = s.getPropertyOptions(i), a = typeof n.converter == "function" ? { fromAttribute: n.converter } : ((o = n.converter) == null ? void 0 : o.fromAttribute) !== void 0 ? n.converter : z;
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const C = globalThis, N = C.trustedTypes, K = N ? N.createPolicy("lit-html", { createHTML: (r) => r }) : void 0, st = "$lit$", _ = `lit$${(Math.random() + "").slice(9)}$`, it = "?" + _, mt = `<${it}>`, g = document, P = () => g.createComment(""), x = (r) => r === null || typeof r != "object" && typeof r != "function", rt = Array.isArray, gt = (r) => rt(r) || typeof (r == null ? void 0 : r[Symbol.iterator]) == "function", k = `[ 	
\f\r]`, S = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, Z = /-->/g, F = />/g, A = RegExp(`>|${k}(?:([^\\s"'>=/]+)(${k}*=${k}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"), G = /'/g, Q = /"/g, nt = /^(?:script|style|textarea|title)$/i, yt = (r) => (t, ...e) => ({ _$litType$: r, strings: t, values: e }), vt = yt(1), v = Symbol.for("lit-noChange"), d = Symbol.for("lit-nothing"), X = /* @__PURE__ */ new WeakMap(), m = g.createTreeWalker(g, 129);
function ot(r, t) {
...
const Et = (r, t) => {
  ...
  for (let a = 0; a < e; a++) {
    ...
    for (; u < h.length && (n.lastIndex = u, p = n.exec(h), p !== null); )
      u = n.lastIndex, n === S ? p[1] === "!--" ? n = Z : p[1] !== void 0 ? n = F : p[2] !== void 0 ? (nt.test(p[2]) && (i = RegExp("</" + p[2], "g")), n = A) : p[3] !== void 0 && (n = A) : n === A ? p[0] === ">" ? (n = i ?? S, l = -1) : p[1] === void 0 ? l = -2 : (l = n.lastIndex - p[2].length, c = p[1], n = p[3] === void 0 ? A : p[3] === '"' ? Q : G) : n === Q || n === G ? n = A : n === Z || n === F ? n = S : (n = A, i = void 0);
    const $ = n === A && r[a + 1].startsWith("/>") ? " " : "";
    o += n === S ? h + mt : l >= 0 ? (s.push(c), h.slice(0, l) + st + h.slice(l) + _ + $) : h + _ + (l === -2 ? a : $);
  }
        ...
        if (i.hasAttributes())
          for (const l of i.getAttributeNames())
            if (l.endsWith(st)) {
              ...
              h.push({ type: 1, index: o, name: H[2], strings: $, ctor: H[1] === "." ? bt : H[1] === "?" ? Ct : H[1] === "@" ? wt : R }), i.removeAttribute(l);
            } else
...
class St {
  ...
  u(t) {
    ...
    for (; h !== void 0; ) {
      if (n === h.index) {
        let c;
        h.type === 2 ? c = new T(o, o.nextSibling, this, t) : h.type === 1 ? c = new h.ctor(o, h.name, h.strings, this, t) : h.type === 6 && (c = new Pt(o, this, t)), this._$AV.push(c), h = s[++a];
      }
...
class T {
  ...
  k(t) {
    ...
    let s, i = 0;
    for (const o of t)
      i === e.length ? e.push(s = new T(this.S(P()), this.S(P()), this, this.options)) : s = e[i], s._$AI(o), i++;
...
var Ut = Object.defineProperty, Tt = Object.getOwnPropertyDescriptor, Ht = (r, t, e, s) => {
